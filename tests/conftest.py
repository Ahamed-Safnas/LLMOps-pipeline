# this code is in conftest.py to provide fixtures for multiple test modules, and to avoid circular 
# imports when patching classes used across modules under test
...
# what : Fake browser/client for testing API.
# Why : You want to test endpoints without manually opening browser.
...
# fixture
# What : Reusable setup block.
# Why : Avoid repeating setup code in every test.
